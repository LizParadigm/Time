...
@Component({
  selector: 'app-modificar-recordatorio',
  templateUrl: './modificar-recordatorio.component.html',
  styleUrl: './modificar-recordatorio.component.css'
})
export class ModificarRecordatorioComponent {
  ...
  constructor(
    ...
    public dialogRef: DialogRef<ModificarRecordatorioComponent>,
